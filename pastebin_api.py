...
API_DEV_KEY = 'MEfCD2O948Ak1MtPBgziZ_bwqkZIGxNP'
...
def post_new_paste(title, body_text, expiration='N', listed=True):
    ...
    if resp_msg.status_code == requests.codes.ok:
        ...
        print(f'Stust code: {resp_msg.status_code} ({resp_msg.reason})')

def main():
    post_new_paste('Awesome Paste', 'This past is not useful.\ndelete whenever.', '1H', False)
